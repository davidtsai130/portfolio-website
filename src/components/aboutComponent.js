    ...
    return (
      <div>
        ...
        <div className="row">
          ...
          <div className="col-sm-12 col-md-6 col-lg-6">
            <p>
              I&#39;m a full stack web developer that is passionate about learning and implementing new technologies. I specialize in Rails and React JS. Check out some of the web applications I have developed <Link to="/portfolio"> here. </Link>
            </p>
          </div>
        </div>
