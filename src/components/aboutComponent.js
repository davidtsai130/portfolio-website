      ...
      <div>
        ...
        <Grid id="about_me">
          <Row>
            ...
            <Col xs={12} sm={6} md={6} lg={6}>
              <p>
                I&#39;m a full stack web developer that is passionate about learning and implementing new technologies. I specialize in Rails and React JS/Redux. Check out <Link to="/portfolio"> my portfolio </Link> to see some of the web applications I have worked on.
              </p>
            </Col>
          </Row>
          <Row>
            <Col xs={12} sm={6} md={6} lg={6}>
              ...
              <Row>
                <Col id="first" xs={4} sm={4} md={4} lg={4}>
                  <ul>
                  {this.handleSkills(this.props.first)}
                  </ul>
                </Col>
                <Col id="second" xs={4} sm={4} md={4} lg={4}>
                <ul>
                  {this.handleSkills(this.props.second)}
                </ul>
                </Col>
                <Col id="third" xs={4} sm={4} md={4} lg={4}>
                <ul>
                  {this.handleSkills(this.props.third)}
                </ul>
                </Col>
              </Row>
            </Col>
