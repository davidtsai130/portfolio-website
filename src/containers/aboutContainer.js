...
class AboutContainer extends Component {
  constructor(props) {
    super(props)
    this.state = {skills: ['CSS3', 'HTML5', 'Javascript', 'Jquery', 'MySQL',
                    'Postgres', 'Rails', 'React', 'Redux', 'Ruby',
                    'Sinatra'],
                  skillOne: [],
                  skillTwo: [],
                  skillThree: []}
        ...
        <div className="container container-margin">
          <div className="row">
            <div className="col-lg-12 col-md-12 col-sm-12">
              <AboutComponent first={this.state.skillOne} second={this.state.skillTwo} third={this.state.skillThree}/>
            </div>
          </div>
        </div>
      </div>
